...
int main(void)
{
    ...
    //初始化链表，并添加商品信息
    Head = List_Init();
    LL Data1 = {1, 2, "apple", 2.5, "S:/root/product/pic/apple.png", 10};
    list_TailInsert(Head, Data1);

    LL Data2 = {2, 3, "candy", 0.5, "S:/root/product/pic/candy.png", 10};
    list_TailInsert(Head, Data2);

    LL Data3 = {3, 3, "chips", 4, "S:/root/product/pic/chips.png", 10};
    list_TailInsert(Head, Data3);

    LL Data4 = {4, 3, "chocolate", 2.5, "S:/root/product/pic/chocolate.png", 10};
    list_TailInsert(Head, Data4);

    LL Data5 = {5, 4, "coconut", 5.5, "S:/root/product/pic/coconut.png", 10};
    list_TailInsert(Head, Data5);

    LL Data6 = {6, 4, "coffe", 4.5, "S:/root/product/pic/coffee.png", 10};
    list_TailInsert(Head, Data6);

    LL Data7 = {7, 3, "cookien", 1.0, "S:/root/product/pic/cukin.png", 10};
    list_TailInsert(Head, Data7);

    LL Data8 = {8, 2, "dragon", 2.5, "S:/root/product/pic/dragon.png", 10};
    list_TailInsert(Head, Data8);

    LL Data9 = {9, 2, "grape", 3.0, "S:/root/product/pic/grape.png", 10};
    list_TailInsert(Head, Data9);

    LL Data10 = {10, 3, "hotdog", 2.5, "S:/root/product/pic/hotdog.png", 10};
    list_TailInsert(Head, Data10);

    LL Data11 = {11, 4, "icecream", 2.5, "S:/root/product/pic/icecream.png", 10};
    list_TailInsert(Head, Data11);

    LL Data12 = {12, 3, "kebab", 2.0, "S:/root/product/pic/kebabe.png", 10};
    list_TailInsert(Head, Data12);

    LL Data13 = {13, 2, "lemon", 2.0, "S:/root/product/pic/lemon.png", 10};
    list_TailInsert(Head, Data13);

    LL Data14 = {14, 3, "mantou", 1.5, "S:/root/product/pic/mantou.png", 10};
    list_TailInsert(Head, Data14);

    LL Data15 = {15, 3, "wiki", 2.5, "S:/root/product/pic/mi.png", 10};
    list_TailInsert(Head, Data15);

    LL Data16 = {16, 2, "watermel", 6.0, "S:/root/product/pic/watermelon1.png", 10};
    list_TailInsert(Head, Data16);

    LL Data17 = {17, 2, "orange", 2.0, "S:/root/product/pic/orange.png", 10};
    list_TailInsert(Head, Data17);

    LL Data18 = {18, 2, "pear", 2.5, "S:/root/product/pic/pear.png", 10};
    list_TailInsert(Head, Data18);

    LL Data19 = {19, 3, "pie", 2.5, "S:/root/product/pic/pie1.png", 10};
    list_TailInsert(Head, Data19);

    LL Data20 = {20, 3, "sandwich", 4.5, "S:/root/product/pic/sandwich.png", 10};
    list_TailInsert(Head, Data20);

    LL Data21 = {21, 2, "mangoste", 3.5, "S:/root/product/pic/shan.png", 10};
    list_TailInsert(Head, Data21);

    LL Data22 = {22, 2, "persim", 2.5, "S:/root/product/pic/shi.png", 10};
    list_TailInsert(Head, Data22);

    LL Data23 = {23, 4, "tea", 3.5, "S:/root/product/pic/tea.png", 10};
    list_TailInsert(Head, Data23);
